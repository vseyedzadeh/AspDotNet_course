<%@ Page Language="C#" MasterPageFile="~/DefaulMaster.Master" AutoEventWireup="true" CodeBehind="Customers.aspx.cs" Inherits="videoRentalStore.Customers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="mainContentPH" runat="server">
    <div>
        ...
        <asp:DetailsView ID="DtlViewCustomer" runat="server" AutoGenerateRows="False" CellPadding="4" DataKeyNames="ID" DataSourceID="CustomerDetailsViewDS" ForeColor="#333333" GridLines="None" Height="50px" Width="541px" OnPageIndexChanging="DtlViewCustomer_PageIndexChanging">
            <AlternatingRowStyle BackColor="White" />
